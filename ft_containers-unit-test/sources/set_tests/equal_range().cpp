...
std::vector<int> equal_range_test(_set<T> st) {
    ...
    st.insert(60);
    g_start2 = timer();
    const _pair<_set<int>::iterator , _set<int>::iterator>& pair = st.equal_range(10);
    const _pair<_set<int>::iterator , _set<int>::iterator>& pair2 = st.equal_range(11);
    const _pair<_set<int>::iterator , _set<int>::iterator>& pair3 = st.equal_range(1);
    g_end2 = timer();
    v.push_back(*(pair.first));
    v.push_back(*(pair.second));
    v.push_back(*(pair2.first));
