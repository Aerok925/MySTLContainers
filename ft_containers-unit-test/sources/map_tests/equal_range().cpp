...
std::vector<int> equal_range_test(std::map<T, V> mp) {
    ...
    g_start1 = timer();
    const std::pair<std::map<int, int>::iterator , std::map<int, int>::iterator>& pair = mp.equal_range(10);
    const std::pair<std::map<int, int>::iterator , std::map<int, int>::iterator>& pair2 = mp.equal_range(11);
    const std::pair<std::map<int, int>::iterator , std::map<int, int>::iterator>& pair3 = mp.equal_range(1);
    g_end1 = timer();
...
std::vector<int> equal_range_test(_map<T, V> mp) {
    ...
    g_start2 = timer();
    const _pair<_map<int, int>::iterator , _map<int, int>::iterator>& pair = mp.equal_range(10);
    const _pair<_map<int, int>::iterator , _map<int, int>::iterator>& pair2 = mp.equal_range(11);
    const _pair<_map<int, int>::iterator , _map<int, int>::iterator>& pair3 = mp.equal_range(1);
    g_end2 = timer();
    v.push_back(pair.first->first);
    v.push_back(pair.first->second);
    v.push_back(pair.second->first);
